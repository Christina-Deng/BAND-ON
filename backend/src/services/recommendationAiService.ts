...
const SYSTEM_PROMPT_ZH = `你是 BAND·ON 乐队排练顾问。曲目已由系统选定，你只需为每首歌写推荐理由。
...
const SYSTEM_PROMPT_EN = `You are BAND·ON, a band rehearsal advisor. Songs are pre-selected — write a recommendation reason for each only.
